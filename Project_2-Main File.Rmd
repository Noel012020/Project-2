...
```
## Description of Plot 1 with Function
This plot produces the same visualization as the original code. The "make_plot" function was used to create the visualtion. A conditional was added to the geom text layer to include labels for the number of games sold by each publisher if the value was greater than 1. This feature adds an additional visual element that makes interpreting the data easier. 
