...
This plot produces the same visualization as the original code. A "make_plot" function was made to simplify the code and accept arguments including the data set, x variable, y variable, and geom layer style. A loop was used to create the median values of number of sold copies (x100000) for each platform, providing a better understanding of which kind of platforms get more sales based on their games.
